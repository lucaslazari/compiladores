clear
echo "ARGUMENTOS E PARÂMETROS - CERTO"
./main input/sem/apc1.txt input/sem/apc1.i
echo "ARGUMENTOS E PARÂMETROS - CERTO"
./main input/sem/apc2.txt input/sem/apc2.i
echo "ARGUMENTOS E PARÂMETROS - ERRADO"
./main input/sem/ape1.txt input/sem/ape1.i
echo "ARGUMENTOS E PARÂMETROS - ERRADO"
./main input/sem/ape2.txt input/sem/ape2.i
echo "DECLARAÇÕES - CERTO"
./main input/sem/dcc1.txt input/sem/dcc1.i
echo "DECLARAÇÕES - CERTO"
./main input/sem/dcc2.txt input/sem/dcc2.i
